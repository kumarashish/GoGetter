   ...
   ProgressBar pb;
    ...
    private AdapterView.OnItemClickListener mAutocompleteClickListener
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            getLocation(placeId,String.valueOf(item.description));
    ...
    public void getLocation(String placeId, final String placeName) {
                ...
                .setResultCallback(new ResultCallback<PlaceBuffer>() {
                    ...
                    public void onResult(PlaceBuffer places) {
                        if (places.getStatus().isSuccess()) {
                            ...
                            Registration.deliveryList.add(new DeliveryLocationModel(placeName,Double.toString(queriedLocation.latitude),Double.toString(queriedLocation.longitude)));
                            in.putExtra("Location",placeName);
    ...
    public void onLocationChanged(Location location) {
        if (location != null) {
            ...
            String address = Common.getCompleteAddressString(LocationSearch.this, location.getLatitude(), location.getLongitude());
            mAutocompleteTextView.setText(address);
            LatLng loc=new LatLng(location.getLatitude(),location.getLongitude());
            if( isLocationAlreadyAdded(address)==false ) {
                Registration.deliveryList.add(new DeliveryLocationModel(address, Double.toString(loc.latitude), Double.toString(loc.longitude)));
            }
    ...
    boolean isLocationAlreadyAdded(String locationname) {
        for (int i = 0; i < Registration.deliveryList.size(); i++) {
            if (Registration.deliveryList.get(i).locationName.equalsIgnoreCase(locationname)) {
                return true;
            }
        }
        return false;
